...
+ (NSString*) postReKognitionJobsByUrl:(NSString *) jobs imageUrl:(NSString *) imageUrl{
    
    NSString *str= [NSString stringWithFormat:@"http://rekognition.com/func/api/?api_key=%@&api_secret=%@&jobs=%@&urls=%@", API_Key, API_Secret, jobs, imageUrl];
